...
//         try {
//             const res = await fetch('https://sameer.edigitalindian.com/api/admin/seminar_api.php');
...
//         await fetch('https://sameer.edigitalindian.com/api/admin/seminar_api.php', { method: 'POST', body: formData });
//         fetchSeminars();
//     };
