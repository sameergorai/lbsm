                    ...
                    <div className="px-1 mx-auto flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <div className=" md:p-6  text-center lg:text-left">
                            ...
                            <ul className="list-disc list-inside text-gray-700 space-y-2 mt-4">
                                <li>Students must attend their classes regularly. 75% attendance for degree classes is compulsory. There is no relaxation regarding this.</li>
                                <li>Students must maintain proper discipline in the college campus. Any act of indiscipline would invite strict punishment.</li>
                                <li>Students must deposit their college-fee on time.</li>
                                <li>Duly filled in Registration Form / Enlistment Form / Examination form along with requisite Fee must be submitted on time and the college authority will not be responsible for any adverse consequences on account of delay in submission of the form & fee.</li>
                                <li>Students must abide by the Jharkhand conduct of examination bill passed by the government of Jharkhand.</li>
                                <li>No association, society or clubs can be formed without the permission of the principal.</li>
                                <li>No meeting is allowed to be convened or no outsider can be invited for any lecture in the college without prior permission.</li>
                                <li>Teaching hours from 8.00 a.m. to 3.00 p.m. Office hours 10 p.m. to 4 p.m.</li>
                                <li>Stick no bills inside the campus.</li>
                                <li>Students are not allowed to carry mobile phones camera etc. within the college premises.</li>
                                <li>Students are not allowed without uniform. They must maintain dress code.</li>
                            </ul>
                            ...
                            <div className="font-semibold my-6">Degree Course</div>
<ul>
    <li><b>For Boys</b> : Light Blue Shirt and Black Pants.</li>
    <li><b>For Girls</b> : Light Blue Kurta, Black Salwar and Black Dupatta.</li>
</ul>
                        </div>
